      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <h2 className="text-lg font-bold leading-tight text-orange-500">
                  Publication
                </h2>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Empowering young minds with colorful, engaging, and educational
              books. We believe in making learning a joyful journey for every
              child.
            </p>
            <div className="flex gap-4 pt-2">
              <Link
                href="https://www.facebook.com/profile.php?id=100082712320958"
                className="bg-gray-800 p-2 rounded-full hover:bg-orange-600 transition text-white">
                <FaFacebook size={18} />
              </Link>
              {/* <Link
                href="#"
              ...
              <Link
                href="https://www.instagram.com/orangebookpublication/"
                className="bg-gray-800 p-2 rounded-full hover:bg-orange-600 transition text-white">
                <FaInstagram size={18} />
              </Link>
              {/* <Link
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-400">
              ...
              <li className="flex items-center gap-3">
                ...
                <span>+91 94998 88801</span>
              </li>
              <li className="flex items-center gap-3">
                <FaEnvelope className="text-orange-500 shrink-0" />
                <span>orangebookpublication2020@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} Orange Book Publication. All rights
            reserved.
          </p>
