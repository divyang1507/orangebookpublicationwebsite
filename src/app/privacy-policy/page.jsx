    ...
    <div className="min-h-screen bg-gray-50 py-12 px-6 md:px-12">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-2xl shadow-sm border border-gray-200">
        ...
        <div className="space-y-6 text-gray-700">
          <p>
            Welcome to Orange Book Publication ("we," "our," or "us"). We are
          ...
          <p>
            ...
            account, make a purchase, or contact us. This includes:
          </p>
          ...
          <p>
            ...
            We may share data with trusted service providers (e.g., shipping
            companies, payment gateways) solely to fulfill your orders.
          </p>
